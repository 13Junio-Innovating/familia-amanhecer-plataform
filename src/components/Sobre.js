  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-6">
      <p className="text-lg my-16"> {/* Aqui você pode ajustar a classe `my-8` para controlar o espaçamento vertical */}
        ...
        <p>Estudante de Psicologia Positiva, com 29 anos de experiência como Educadora<br/> nas Prisões do Estado de São Paulo.</p>
        ...
        Practitioner em Programação Neurolinguística, Mentoring e Neurocoaching.<br/> 
        Professora e Ex-Coordenadora Pedagógica na ETEC<br />
